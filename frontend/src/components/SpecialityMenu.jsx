...
const SpecialityMenu = () => {
    return (
        <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-[#262626]'>
            ...
            <p className='sm:w-1/3 text-center text-sm'>Easily explore our wide network of verified doctors and book your appointment with confidence, without any hassle.</p>
